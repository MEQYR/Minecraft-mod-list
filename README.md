...
4. Nginx (для панели)
5. Docker (для панели)
6. GNU Screen? (Много терминалов это круто)

**Что надо найти**:
1. Веб-интерфейс для администрирования сервера (Webmin? - с ним сложно работать но имеет очень много фич)
2. Инструменты для автоматического бэкапирования (Duplicity? - должен подойти но нужно проверять)
3. Веб-интерфейс для управления майнкрафт сервера
